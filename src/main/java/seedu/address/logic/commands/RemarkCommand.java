...
public class RemarkCommand extends Command {
    ...
    private String generateSuccessMessage(Person personToEdit) {
        return !remark.value.trim().isEmpty()
                ? String.format(MESSAGE_ADD_REMARK_SUCCESS, personToEdit.getName())
                : String.format(MESSAGE_DELETE_REMARK_SUCCESS, personToEdit.getName());
    }
